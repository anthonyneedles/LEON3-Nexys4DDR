...
HD_PWD='E:/525.612/Needles_LEON3/Needles_LEON3/Needles_LEON3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys4_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys4_top.tcl -notrace
