...
HD_PWD='E:/525.612/Needles_LEON3/Needles_LEON3/Needles_LEON3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys4_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys4_top.tcl
