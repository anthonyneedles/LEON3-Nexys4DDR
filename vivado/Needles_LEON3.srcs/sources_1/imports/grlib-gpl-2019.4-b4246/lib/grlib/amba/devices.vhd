...
-- Contribution library IDs
  ...
  constant CUSTOM_LED : amba_device_type := 16#001#;
...
-- Johns Hopkins University Applied Physics Lab IDs
  constant JHUAPL_LED           : amba_device_type := 16#001#;
...
-- pragma translate_off
  ...
  constant gaisler_device_table : device_table_type := (
    ...
    GAISLER_LED           => "Custom LED APB Device           ",
  ...
  constant CONTRIB_DESC : vendor_description := "Custom Devices          ";

  constant contrib_device_table : device_table_type := (
    CUSTOM_LED =>    "Custom LED Controller Device    ",
  ...
  constant jhuapl_sri_device_table : device_table_type := (
    JHUAPL_LED => "Custom LED APB Device           ",
    others =>     "Unknown Device                  ");
